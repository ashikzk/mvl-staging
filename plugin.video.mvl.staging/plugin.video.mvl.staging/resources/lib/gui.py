...
class GUI( xbmcgui.WindowXMLDialog ):
  ...
  def set_allparam(self):
    ...
    self.language_1      = languageTranslate(__addon__.getSetting("lang"),0,0)     # Full language 1
  ...
  def list_languages(self):
    ...
    listitem = xbmcgui.ListItem( self.lang_1 )
    self.list.append(self.lang_1)
    listitem.setProperty( "man", "false" )
    all_items.append(listitem)
    listitem = xbmcgui.ListItem( self.lang_2 )
    self.list.append(self.lang_2)
    listitem.setProperty( "man", "false" )
    all_items.append(listitem)
    listitem = xbmcgui.ListItem( self.lang_3 )
    self.list.append(self.lang_3)
    listitem.setProperty( "man", "false" )
    all_items.append(listitem)
    listitem = xbmcgui.ListItem( self.lang_4 )
    self.list.append(self.lang_4)
    listitem.setProperty( "man", "false" )
    all_items.append(listitem)
    listitem = xbmcgui.ListItem( self.lang_5 )
    self.list.append(self.lang_5)
    listitem.setProperty( "man", "false" )
    all_items.append(listitem)
  ...
  def onClick( self, controlId ):
    if controlId == SUBTITLES_LIST:
      ...
      #self.next = list(self.service_list)
      self.language_1 = self.language_2 = self.language_3 = selection
      __addon__.setSetting(id='lang', value=selection)
      self.Search_Subtitles()
